...
function CopilotView() {
    ...
    return (
        ...
        >
            ...
            <textarea
                className="min-h-[120px] w-full rounded-md border-2 border-blue-500 bg-gray-800 Hover p-2 text-white outline-none"
                placeholder="What code do you want to generate?"
                onChange={(e) => setInput(e.target.value)}
            />
            <button
                className="mt-1 flex w-full justify-center rounded-md bg-blue-500 p-2 font-bold text-white outline-none disabled:cursor-not-allowed disabled:opacity-50"
